...
public class TestResultExplicit {
    ...
    public void testResult() throws Exception {
    	...
    	org.junit.Assert.assertEquals("The result variable declared explicitely in the script is not used as the result of the script by the engine", Boolean.FALSE, (Boolean)res.getResult());
    }		
}
