 ...
 * The default value of an empty script is always true.
...
public class TestResultDefault {
    ...
    public void testResult() throws Exception {		
    	...
    	org.junit.Assert.assertEquals("The default result of an empty script is not set by the engine", Boolean.TRUE, (Boolean)res.getResult());
    }		
}
