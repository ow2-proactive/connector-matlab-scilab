...
public class TestProgress {
    ...
    public void test() throws Exception {
    	...
    	Map<String,Object> aBindings = Collections.singletonMap(TaskScript.PROGRESS_VARIABLE, (Object)progress);
    	...
    	//System.out.println("TestProgress.test1() ---> result " + res.getResult());
    	//System.out.println("TestProgress.test1() error ocured ---> " + res.errorOccured());
    	//System.out.println("TestProgress.test1() exception ---> " + res.getException());
