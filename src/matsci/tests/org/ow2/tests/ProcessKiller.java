...
public abstract class ProcessKiller {
     ...
     *
     * @return A new ProcessKiller object
     * @throws IllegalStateException If the local operating system is not supported
     */
     ...
     *
     * @param pid The pid
     * @throws java.io.IOException  If the process cannot be killed
     * @throws InterruptedException If interrupted while killing the process
     */
