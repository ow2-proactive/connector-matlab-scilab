...
public class ProActiveSetup2 {
     ...
     */
    private static String jvmParameters;
    /**
    ...
    /**
     * Stop everything that had been started by {@link ProActiveSetup2#start}
     *
     * @throws Exception If something goes wrong
     */
    ...
    private String buildJvmParameters() {
        ...
        if (System.getProperty("pas.launcher.forkas.method") != null) {
            jvmParameters.append("-Dpas.launcher.forkas.method=" +
                System.getProperty("pas.launcher.forkas.method") + " ");
            try {
                jvmParameters.append("-D" + CentralPAPropertyRepository.PA_HOME.getName() + "=" +
                    (new File(System.getProperty("pa.scheduler.home"))).getCanonicalPath() + " ");
            } catch (IOException e) {
                e.printStackTrace();
            }
        }
        ...
        if (System.getProperty("proactive.test.runAsMe") != null) {
            jvmParameters.append("-Dproactive.test.runAsMe=true ");
        }
