...
public class ProcessCleaner {
     ...
     *
     * @return PIDs
     * @throws java.io.IOException If PIDs cannot be retrieved
     */
     ...
     *
     * @throws java.io.IOException If some processes cannot be killed
     */
     ...
     *
     * @return All the thread dumps
     * @throws java.io.IOException If a thread dump cannot be retrieved
     */
     ...
     * @throws java.io.IOException If the thread dump cannot be fetched
     */
