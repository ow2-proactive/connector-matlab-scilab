    ...
    private static Properties getProperties() {
        if (prop == null) {
            ...
            try {
                ...
                throw new RuntimeException("Error when loading properties from Matlab/Scilab properties file at : '" +
                                           properties_file + "'", e);
            }
        }
        return prop;
        ...
        if (schedHome == null) {
            ...
            if (pahome != null) {
                ...
                try {
                    ...
                    final String path = MatSciProperties.class.getProtectionDomain()
                                                              .getCodeSource()
                                                              .getLocation()
                                                              .getPath();
