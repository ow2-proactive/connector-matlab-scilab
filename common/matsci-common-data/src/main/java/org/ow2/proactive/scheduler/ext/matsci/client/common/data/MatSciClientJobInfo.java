...
public class MatSciClientJobInfo implements Serializable {
     ...
     */
    public MatSciClientJobInfo(String jobId, TreeSet<String> tnames, TreeSet<String> finaltnames, int nbres, int depth,
            String dirToClean, HashMap<String, String> outVariablesFiles, PASolveMatSciGlobalConfig conf,
            PASolveMatSciTaskConfig[][] tconfs) {
